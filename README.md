...
```text
RemoteJobBoard/
├── JobBoardBackend/       # ASP.NET Core 10 Web API Project
│   ├── Controllers/       # API Endpoints (Auth, Jobs, Applications)
│   ├── Data/              # ApplicationDbContext & Migrations
│   ├── Models/            # Database Entities & DTOs
│   └── Program.cs         # Dependency Injection, CORS & Middleware
└── job-board-frontend/    # Next.js Frontend Application
    ├── public/            # Static Assets (Logo, Icons)
    └── src/
        ├── app/           # App Router (Dashboards, Login, Register, Dynamic Job Details)
